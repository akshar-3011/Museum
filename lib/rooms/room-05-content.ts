export const ROOM_05_CONTENT = {
  threshold: {
    roomTag: "ROOM 05 / FINAL ARCHIVE",
    title: "Closing the Record",
    subtitle: "The collection ends here. Not because there is nothing left to record, but because the archive is no longer necessary.",
  },
  exhibits: {
    caseFile: {
      id: "exhibit1",
    ...
    statements: {
      ...
      items: [
        "The nickname outlasted the joke.",
        "The observations were never an accident.",
        "Vidhi is still there, but Mango never left.",
      ],
    },
    missingPage: {
      id: "exhibit4",
      ...
      copy: "The archive only contains what has already happened. The rest of the space is left deliberately empty. It is not a missing record. It's just tomorrow.",
    },
  },
  hiddenArchive: {
    label: "MISSED ITEMS",
  ...
  finalScreen: {
    closingLine: "You were always worth paying attention to.",
  },
};
